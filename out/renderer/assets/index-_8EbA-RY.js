...
function FileExplorer({
  ...
  const [nodeState, setNodeState] = reactExports.useState({});
  ...
  function renderEntry(entry, depth) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      entry.isDirectory && state?.expanded && state.children?.map((child) => renderEntry(child, depth + 1))
    ] }, entry.path);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel-title", children: "Explorer" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: rootEntries.map((entry) => renderEntry(entry, 0)) })
  ] });
}
function SourceControlPanel({ workspaceRoot, refreshToken }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel-title", children: "Source Control" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0 10px 10px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "primary", onClick: commit, disabled: busy || !message.trim(), children: "Commit" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "var(--text-dim)", padding: "0 10px 4px" }, children: status ? `Branch: ${status.branch}` : "Não é um repositório git" }),
    status?.files.map((f2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        onClick: () => stage(f2.path),
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: f2.path }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text-dim)" }, children: f2.status[0].toUpperCase() })
        ]
      },
      f2.path
    ))
...
(function(module, exports) {
  !function(e, t2) {
    ...
    var e = { 4567: function(e2, t3, i2) {
      ...
      const n2 = i2(9042), o = i2(6114), a = i2(9924), h2 = i2(844), c = i2(5596), l2 = i2(4725), d = i2(3656);
      let _2 = t3.AccessibilityManager = class extends h2.Disposable {
        ...
        _renderRows(e3, t4) {
          ...
          for (let r3 = e3; r3 <= t4; r3++) {
            const e4 = i3.translateBufferLineToString(i3.ydisp + r3, true), t5 = (i3.ydisp + r3 + 1).toString(), n3 = this._rowElements[r3];
            n3 && (0 === e4.length ? n3.innerText = " " : n3.textContent = e4, n3.setAttribute("aria-posinset", t5), n3.setAttribute("aria-setsize", s3));
          }
      ...
      t3.AccessibilityManager = _2 = s2([r2(1, l2.IRenderService)], _2);
    }, 3614: (e2, t3) => {
      function i2(e3) {
        return e3.replace(/\r?\n/g, "\r");
      }
      ...
      const n2 = i2(3656), o = i2(8460), a = i2(844), h2 = i2(2585);
      let c = t3.Linkifier2 = class extends a.Disposable {
        ...
        attachToDom(e3, t4, i3) {
          this._element = e3, this._mouseService = t4, this._renderService = i3, this.register((0, n2.addDisposableDomListener)(this._element, "mouseleave", () => {
        ...
        _askForLink(e3, t4) {
          ...
          let r3 = false;
          for (const [i4, n3] of this._linkProviders.entries()) t4 ? (null === (s3 = this._activeProviderReplies) || void 0 === s3 ? void 0 : s3.get(i4)) && (r3 = this._checkLinkProviderResult(i4, e3, r3)) : n3.provideLinks(e3.y, (t5) => {
            var s4, n4;
            if (this._isMouseOut) return;
            const o2 = null == t5 ? void 0 : t5.map((e4) => ({ link: e4 }));
            null === (s4 = this._activeProviderReplies) || void 0 === s4 || s4.set(i4, o2), r3 = this._checkLinkProviderResult(i4, e3, r3), (null === (n4 = this._activeProviderReplies) || void 0 === n4 ? void 0 : n4.size) === this._linkProviders.length && this._removeIntersectingLinks(e3.y, this._activeProviderReplies);
          });
        }
        ...
        _checkLinkProviderResult(e3, t4, i3) {
          ...
          const r3 = this._activeProviderReplies.get(e3);
          let n3 = false;
          for (let t5 = 0; t5 < e3; t5++) this._activeProviderReplies.has(t5) && !this._activeProviderReplies.get(t5) || (n3 = true);
          if (!n3 && r3) {
            const e4 = r3.find((e5) => this._linkAtPosition(e5.link, t4));
          ...
          if (this._activeProviderReplies.size === this._linkProviders.length && !i3) for (let e4 = 0; e4 < this._activeProviderReplies.size; e4++) {
            const r4 = null === (s3 = this._activeProviderReplies.get(e4)) || void 0 === s3 ? void 0 : s3.find((e5) => this._linkAtPosition(e5.link, t4));
            if (r4) {
              i3 = true, this._handleNewLink(r4);
              break;
            }
          }
          return i3;
        ...
        _handleNewLink(e3) {
          ...
          t4 && this._linkAtPosition(e3.link, t4) && (this._currentLink = e3, this._currentLink.state = { decorations: { underline: void 0 === e3.link.decorations || e3.link.decorations.underline, pointerCursor: void 0 === e3.link.decorations || e3.link.decorations.pointerCursor }, isHovered: true }, this._linkHover(this._element, e3.link, this._lastMouseEvent), e3.link.decorations = {}, Object.defineProperties(e3.link.decorations, { pointerCursor: { get: () => {
            ...
            var i3, s3, r3;
            (null === (i3 = this._currentLink) || void 0 === i3 ? void 0 : i3.state) && (null === (r3 = null === (s3 = this._currentLink) || void 0 === s3 ? void 0 : s3.state) || void 0 === r3 ? void 0 : r3.decorations.underline) !== t5 && (this._currentLink.state.decorations.underline = t5, this._currentLink.state.isHovered && this._fireUnderlineEvent(e3.link, t5));
      ...
      t3.Linkifier2 = c = s2([r2(0, h2.IBufferService)], c);
    }, 9042: (e2, t3) => {
      ...
      let a = t3.OscLinkProvider = class {
        ...
        provideLinks(e3, t4) {
          ...
          if (!s3) return void t4(void 0);
          const r3 = [], o2 = this._optionsService.rawOptions.linkHandler, a2 = new n2.CellData(), c = s3.getTrimmedLength();
          let l2 = -1, d = -1, _2 = false;
          for (let t5 = 0; t5 < c; t5++) if (-1 !== d || s3.hasContent(t5)) {
            if (s3.loadCell(t5, a2), a2.hasExtendedAttrs() && a2.extended.urlId) {
              if (-1 === d) {
                d = t5, l2 = a2.extended.urlId;
                continue;
              }
            ...
            if (_2 || -1 !== d && t5 === c - 1) {
              ...
              if (s4) {
                const i4 = { start: { x: d + 1, y: e3 }, end: { x: t5 + (_2 || t5 !== c - 1 ? 0 : 1), y: e3 } };
                let n3 = false;
                ...
                n3 || r3.push({ text: s4, range: i4, activate: (e4, t6) => o2 ? o2.activate(e4, t6, i4) : h2(0, t6), hover: (e4, t6) => {
                  var s5;
              ...
              _2 = false, a2.hasExtendedAttrs() && a2.extended.urlId ? (d = t5, l2 = a2.extended.urlId) : (d = -1, l2 = -1);
            }
          }
          t4(r3);
        }
...
WARNING: This link could potentially be dangerous`)) {
      ...
      const s2 = i2(3614), r2 = i2(3656), n2 = i2(6465), o = i2(9042), a = i2(3730), h2 = i2(1680), c = i2(3107), l2 = i2(5744), d = i2(2950), _2 = i2(1296), u2 = i2(428), f2 = i2(4269), v2 = i2(5114), p2 = i2(8934), g = i2(3230), m2 = i2(9312), S2 = i2(4725), C2 = i2(6731), b = i2(8055), y2 = i2(8969), w2 = i2(8460), E2 = i2(844), k2 = i2(6114), L2 = i2(8437), D2 = i2(2584), R2 = i2(7399), x2 = i2(5941), A2 = i2(9074), B2 = i2(2585), T2 = i2(5435), M2 = i2(4567), O2 = "undefined" != typeof window ? window.document : null;
          ...
          if (this._themeService) for (const t4 of e3) {
            ...
            switch (t4.type) {
              case 0:
                ...
                break;
              case 1:
                if ("ansi" === e4) this._themeService.modifyColors((e5) => e5.ansi[t4.index] = b.rgba.toColor(...t4.color));
                else {
                  const i4 = e4;
      ...
      const n2 = i2(3656), o = i2(4725), a = i2(8460), h2 = i2(844), c = i2(2585);
      let l2 = t3.Viewport = class extends h2.Disposable {
        constructor(e3, t4, i3, s3, r3, o2, h3, c2) {
        ...
        getBufferElements(e3, t4) {
          var i3;
          let s3, r3 = "";
          const n3 = [], o2 = null != t4 ? t4 : this._bufferService.buffer.lines.length, a2 = this._bufferService.buffer.lines;
          for (let t5 = e3; t5 < o2; t5++) {
            const e4 = a2.get(t5);
            if (!e4) continue;
            const o3 = null === (i3 = a2.get(t5 + 1)) || void 0 === i3 ? void 0 : i3.isWrapped;
            if (r3 += e4.translateToString(!o3), !o3 || t5 === a2.length - 1) {
              const e5 = document.createElement("div");
              e5.textContent = r3, n3.push(e5), r3.length > 0 && (s3 = e5), r3 = "";
            }
          }
      ...
      const n2 = i2(3656), o = i2(4725), a = i2(844), h2 = i2(2585);
      let c = t3.BufferDecorationRenderer = class extends a.Disposable {
        ...
        _createElement(e3) {
          ...
          const r3 = null !== (i3 = e3.options.x) && void 0 !== i3 ? i3 : 0;
          return r3 && r3 > this._bufferService.cols && (s3.style.display = "none"), this._refreshXPosition(e3, s3), s3;
        }
        _refreshStyle(e3) {
      ...
      t3.BufferDecorationRenderer = c = s2([r2(1, h2.IBufferService), r2(2, h2.IDecorationService), r2(3, o.IRenderService)], c);
    }, 5871: (e2, t3) => {
      ...
      const n2 = i2(5871), o = i2(3656), a = i2(4725), h2 = i2(844), c = i2(2585), l2 = { full: 0, left: 0, center: 0, right: 0 }, d = { full: 0, left: 0, center: 0, right: 0 }, _2 = { full: 0, left: 0, center: 0, right: 0 };
      let u2 = t3.OverviewRulerRenderer = class extends h2.Disposable {
        get _width() {
          return this._optionsService.options.overviewRulerWidth || 0;
        }
        constructor(e3, t4, i3, s3, r3, o2, a2) {
          var c2;
        ...
        _refreshDrawConstants() {
          ...
          d.full = this._canvas.width, d.left = e3, d.center = t4, d.right = e3, this._refreshDrawHeightConstants(), _2.full = 0, _2.left = 0, _2.center = d.left, _2.right = d.left + d.center;
        }
      ...
      t3.OverviewRulerRenderer = u2 = s2([r2(2, c.IBufferService), r2(3, c.IDecorationService), r2(4, a.IRenderService), r2(5, c.IOptionsService), r2(6, a.ICoreBrowserService)], u2);
      ...
      t3.CompositionHelper = h2 = s2([r2(2, o.IBufferService), r2(3, o.IOptionsService), r2(4, o.ICoreService), r2(5, n2.IRenderService)], h2);
    }, 9806: (e2, t3) => {
      ...
      Object.defineProperty(t3, "__esModule", { value: true }), t3.getCoords = t3.getCoordsRelativeToElement = void 0, t3.getCoordsRelativeToElement = i2, t3.getCoords = function(e3, t4, s2, r2, n2, o, a, h2, c) {
        if (!o) return;
        const l2 = i2(e3, t4, s2);
        return l2 ? (l2[0] = Math.ceil((l2[0] + (c ? a / 2 : 0)) / a), l2[1] = Math.ceil(l2[1] / h2), l2[0] = Math.min(Math.max(l2[0], 1), r2 + (c ? 1 : 0)), l2[1] = Math.min(Math.max(l2[1], 1), n2), l2) : void 0;
      };
    }, 9504: (e2, t3, i2) => {
      ...
      function r2(e3, t4, i3, s3) {
        const r3 = e3 - n2(e3, i3), a2 = t4 - n2(t4, i3), l2 = Math.abs(r3 - a2) - function(e4, t5, i4) {
          ...
          for (let n3 = 0; n3 < Math.abs(r4 - a3); n3++) {
            const a4 = "A" === o(e4, t5) ? -1 : 1, h3 = i4.buffer.lines.get(r4 + a4 * n3);
            (null == h3 ? void 0 : h3.isWrapped) && s4++;
          }
          return s4;
        }(e3, t4, i3);
        return c(l2, h2(o(e3, t4), s3));
      }
      function n2(e3, t4) {
        let i3 = 0, s3 = t4.buffer.lines.get(e3), r3 = null == s3 ? void 0 : s3.isWrapped;
        for (; r3 && e3 >= 0 && e3 < t4.rows; ) i3++, s3 = t4.buffer.lines.get(--e3), r3 = null == s3 ? void 0 : s3.isWrapped;
        return i3;
      }
      function o(e3, t4) {
        return e3 > t4 ? "A" : "B";
      ...
      function a(e3, t4, i3, s3, r3, n3) {
        let o2 = e3, a2 = t4, h3 = "";
        for (; o2 !== i3 || a2 !== s3; ) o2 += r3 ? 1 : -1, r3 && o2 > n3.cols - 1 ? (h3 += n3.buffer.translateBufferLineToString(a2, false, e3, o2), o2 = 0, e3 = 0, a2++) : !r3 && o2 < 0 && (h3 += n3.buffer.translateBufferLineToString(a2, false, 0, e3 + 1), o2 = n3.cols - 1, e3 = o2, a2--);
        return h3 + n3.buffer.translateBufferLineToString(a2, false, e3, o2);
      }
      function h2(e3, t4) {
        const i3 = t4 ? "O" : "[";
      ...
      t3.moveToCellSequence = function(e3, t4, i3, s3) {
        ...
        if (!i3.buffer.hasScrollback) return function(e4, t5, i4, s4, o3, l3) {
          return 0 === r2(t5, s4, o3, l3).length ? "" : c(a(e4, t5, e4, t5 - n2(t5, o3), false, o3).length, h2("D", l3));
        }(o2, l2, 0, t4, i3, s3) + r2(l2, t4, i3, s3) + function(e4, t5, i4, s4, o3, l3) {
          let d2;
          d2 = r2(t5, s4, o3, l3).length > 0 ? s4 - n2(s4, o3) : t5;
          const _3 = s4, u2 = function(e5, t6, i5, s5, o4, a2) {
            let h3;
            return h3 = r2(i5, s5, o4, a2).length > 0 ? s5 - n2(s5, o4) : t6, e5 < i5 && h3 <= s5 || e5 >= i5 && h3 < s5 ? "C" : "D";
          }(e4, t5, i4, s4, o3, l3);
          return c(a(e4, d2, i4, _3, "C" === u2, o3).length, h2(u2, l3));
        }(o2, l2, e3, t4, i3, s3);
        let d;
        if (l2 === t4) return d = o2 > e3 ? "D" : "C", c(Math.abs(o2 - e3), h2(d, s3));
        d = l2 > t4 ? "D" : "C";
        const _2 = Math.abs(l2 - t4);
        return c(function(e4, t5) {
          return t5.cols - e4;
        }(l2 > t4 ? e3 : o2, i3) + (_2 - 1) * i3.cols + 1 + ((l2 > t4 ? o2 : e3) - 1), h2(d, s3));
      };
      ...
      let C2 = 1, b = t3.DomRenderer = class extends _2.Disposable {
        ...
        _injectCss(e3) {
          ...
          let t4 = `${this._terminalSelector} .${v2} { color: ${e3.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px; font-kerning: none; white-space: pre}`;
          t4 += `${this._terminalSelector} .${v2} .xterm-dim { color: ${l2.color.multiplyOpacity(e3.foreground, 0.5).css};}`, t4 += `${this._terminalSelector} span:not(.xterm-bold) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.xterm-bold { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.xterm-italic { font-style: italic;}`, t4 += "@keyframes blink_box_shadow_" + this._terminalClass + " { 50% {  border-bottom-style: hidden; }}", t4 += "@keyframes blink_block_" + this._terminalClass + ` { 0% {  background-color: ${e3.cursor.css};  color: ${e3.cursorAccent.css}; } 50% {  background-color: inherit;  color: ${e3.cursor.css}; }}`, t4 += `${this._terminalSelector} .${v2}.${m2} .xterm-cursor.xterm-cursor-blink:not(.xterm-cursor-block) { animation: blink_box_shadow_` + this._terminalClass + ` 1s step-end infinite;}${this._terminalSelector} .${v2}.${m2} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: blink_block_` + this._terminalClass + ` 1s step-end infinite;}${this._terminalSelector} .${v2} .xterm-cursor.xterm-cursor-block { background-color: ${e3.cursor.css}; color: ${e3.cursorAccent.css};}${this._terminalSelector} .${v2} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${e3.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${v2} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${e3.cursor.css} inset;}${this._terminalSelector} .${v2} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${e3.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`, t4 += `${this._terminalSelector} .${S2} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${S2} div { position: absolute; background-color: ${e3.selectionBackgroundOpaque.css};}${this._terminalSelector} .${S2} div { position: absolute; background-color: ${e3.selectionInactiveBackgroundOpaque.css};}`;
          for (const [i3, s3] of e3.ansi.entries()) t4 += `${this._terminalSelector} .${p2}${i3} { color: ${s3.css}; }${this._terminalSelector} .${p2}${i3}.xterm-dim { color: ${l2.color.multiplyOpacity(s3, 0.5).css}; }${this._terminalSelector} .${g}${i3} { background-color: ${s3.css}; }`;
          t4 += `${this._terminalSelector} .${p2}${a.INVERTED_DEFAULT_COLOR} { color: ${l2.color.opaque(e3.background).css}; }${this._terminalSelector} .${p2}${a.INVERTED_DEFAULT_COLOR}.xterm-dim { color: ${l2.color.multiplyOpacity(l2.color.opaque(e3.background), 0.5).css}; }${this._terminalSelector} .${g}${a.INVERTED_DEFAULT_COLOR} { background-color: ${e3.foreground.css}; }`, this._themeStyleElement.textContent = t4;
        }
        _setDefaultSpacing() {
        ...
        handleSelectionChanged(e3, t4, i3) {
          ...
          const s3 = e3[1] - this._bufferService.buffer.ydisp, r3 = t4[1] - this._bufferService.buffer.ydisp, n3 = Math.max(s3, 0), o2 = Math.min(r3, this._bufferService.rows - 1);
          ...
          if (i3) {
            ...
            const i4 = s3 === n3 ? e3[0] : 0, h3 = n3 === r3 ? t4[0] : this._bufferService.cols;
        ...
        _createSelectionElement(e3, t4, i3, s3 = 1) {
          ...
          return r3.style.height = s3 * this.dimensions.css.cell.height + "px", r3.style.top = e3 * this.dimensions.css.cell.height + "px", r3.style.left = t4 * this.dimensions.css.cell.width + "px", r3.style.width = this.dimensions.css.cell.width * (i3 - t4) + "px", r3;
        }
        handleCursorMove() {
        }
        ...
        renderRows(e3, t4) {
          ...
          for (let h3 = e3; h3 <= t4; h3++) {
            const e4 = h3 + i3.ydisp, t5 = this._rowElements[h3], c2 = i3.lines.get(e4);
            if (!t5 || !c2) break;
        ...
        _setCellUnderline(e3, t4, i3, s3, r3, n3) {
          ...
          for (let o3 = i3; o3 <= s3; ++o3) {
            ...
            if (!f3 || !v3) break;
            f3.replaceChildren(...this._rowFactory.createRow(v3, u3, u3 === h3, d2, _3, c2, l3, this.dimensions.css.cell.width, this._widthCache, n3 ? o3 === i3 ? e3 : 0 : -1, n3 ? (o3 === s3 ? t4 : r3) - 1 : -1));
          }
        }
      };
      t3.DomRenderer = b = s2([r2(4, u2.IInstantiationService), r2(5, c.ICharSizeService), r2(6, u2.IOptionsService), r2(7, u2.IBufferService), r2(8, c.ICoreBrowserService), r2(9, c.IThemeService)], b);
      ...
      const n2 = i2(2223), o = i2(643), a = i2(511), h2 = i2(2585), c = i2(8055), l2 = i2(4725), d = i2(4269), _2 = i2(6171), u2 = i2(3734);
      let f2 = t3.DomRendererRowFactory = class {
        ...
        createRow(e3, t4, i3, s3, r3, a2, h3, l3, _3, f3, p2) {
          ...
          i3 && b < a2 + 1 && (b = a2 + 1);
          let y2 = 0, w2 = "", E2 = 0, k2 = 0, L2 = 0, D2 = false, R2 = 0, x2 = false, A2 = 0;
          ...
          for (let M2 = 0; M2 < b; M2++) {
            ...
            if (" " === N2 && (I2.isUnderline() || I2.isOverline()) && (N2 = " "), A2 = b2 * l3 - _3.get(N2, I2.isBold(), I2.isItalic()), C2) {
              if (y2 && (H2 && x2 || !H2 && !x2 && I2.bg === E2) && (H2 && x2 && S2.selectionForeground || I2.fg === k2) && I2.extended.ext === L2 && W2 === D2 && A2 === R2 && !F2 && !O2 && !U2) {
                w2 += N2, y2++;
                continue;
              }
              y2 && (C2.textContent = w2), C2 = this._document.createElement("span"), y2 = 0, w2 = "";
            } else C2 = this._document.createElement("span");
            if (E2 = I2.bg, k2 = I2.fg, L2 = I2.extended.ext, D2 = W2, R2 = A2, x2 = H2, O2 && a2 >= M2 && a2 <= P2 && (a2 = M2), !this._coreService.isCursorHidden && F2) {
            ...
            if (I2.isBold() && B2.push("xterm-bold"), I2.isItalic() && B2.push("xterm-italic"), I2.isDim() && B2.push("xterm-dim"), w2 = I2.isInvisible() ? o.WHITESPACE_CELL_CHAR : I2.getChars() || o.WHITESPACE_CELL_CHAR, I2.isUnderline() && (B2.push(`xterm-underline-${I2.extended.underlineStyle}`), " " === w2 && (w2 = " "), !I2.isUnderlineColorDefault())) if (I2.isUnderlineColorRGB()) C2.style.textDecorationColor = `rgb(${u2.AttributeData.toColorRGB(I2.getUnderlineColor()).join(",")})`;
            else {
            ...
            I2.isOverline() && (B2.push("xterm-overline"), " " === w2 && (w2 = " ")), I2.isStrikethrough() && B2.push("xterm-strikethrough"), W2 && (C2.style.textDecoration = "underline");
            ...
            }), !J2 && H2 && (V2 = this._coreBrowserService.isFocused ? S2.selectionBackgroundOpaque : S2.selectionInactiveBackgroundOpaque, z2 = V2.rgba >> 8 & 16777215, K2 = 50331648, J2 = true, S2.selectionForeground && (j = 50331648, $2 = S2.selectionForeground.rgba >> 8 & 16777215, G2 = S2.selectionForeground)), J2 && B2.push("xterm-decoration-top"), K2) {
              case 16777216:
              case 33554432:
                X2 = S2.ansi[z2], B2.push(`xterm-bg-${z2}`);
                break;
              case 50331648:
                X2 = c.rgba.toColor(z2 >> 16, z2 >> 8 & 255, 255 & z2), this._addStyle(C2, `background-color:#${v2((z2 >>> 0).toString(16), "0", 6)}`);
                break;
              default:
            ...
            switch (V2 || I2.isDim() && (V2 = c.color.multiplyOpacity(X2, 0.5)), j) {
              ...
              case 50331648:
                ...
                this._applyMinimumContrast(C2, X2, e4, I2, V2, G2) || this._addStyle(C2, `color:#${v2($2.toString(16), "0", 6)}`);
                break;
              default:
                this._applyMinimumContrast(C2, X2, S2.foreground, I2, V2, void 0) || q2 && B2.push(`xterm-fg-${n2.INVERTED_DEFAULT_COLOR}`);
            }
            B2.length && (C2.className = B2.join(" "), B2.length = 0), F2 || O2 || U2 ? C2.textContent = w2 : y2++, A2 !== this.defaultSpacing && (C2.style.letterSpacing = `${A2}px`), g.push(C2), M2 = P2;
          }
          return C2 && y2 && (C2.textContent = w2), g;
        }
        _applyMinimumContrast(e3, t4, i3, s3, r3, n3) {
          ...
          if (r3 || n3 || (a2 = o2.getColor(t4.rgba, i3.rgba)), void 0 === a2) {
            ...
            a2 = c.color.ensureContrastRatio(r3 || t4, n3 || i3, e4), o2.setColor((r3 || t4).rgba, (n3 || i3).rgba, null != a2 ? a2 : null);
          }
      ...
      Object.defineProperty(t3, "__esModule", { value: true }), t3.WidthCache = void 0, t3.WidthCache = class {
        constructor(e3) {
          ...
          r2.style.fontWeight = "bold", r2.style.fontStyle = "italic", this._measureElements = [t4, i2, s2, r2], this._container.appendChild(t4), this._container.appendChild(i2), this._container.appendChild(s2), this._container.appendChild(r2), e3.body.appendChild(this._container), this.clear();
        }
        dispose() {
        ...
        get(e3, t4, i2) {
          let s2 = 0;
          if (!t4 && !i2 && 1 === e3.length && (s2 = e3.charCodeAt(0)) < 256) return -9999 !== this._flat[s2] ? this._flat[s2] : this._flat[s2] = this._measure(e3, 0);
          let r2 = e3;
          t4 && (r2 += "B"), i2 && (r2 += "I");
          let n2 = this._holey.get(r2);
          if (void 0 === n2) {
            let s3 = 0;
            t4 && (s3 |= 1), i2 && (s3 |= 2), n2 = this._measure(e3, s3), this._holey.set(r2, n2);
          }
          return n2;
        }
        _measure(e3, t4) {
      ...
      const n2 = i2(3734), o = i2(643), a = i2(511), h2 = i2(2585);
      ...
      let l2 = t3.CharacterJoinerService = class e3 {
        ...
        getJoinedCharacters(e4) {
          ...
          let r3 = 0, n3 = 0, a2 = 0, h3 = t4.getFg(0), c2 = t4.getBg(0);
          for (let e5 = 0; e5 < t4.getTrimmedLength(); e5++) if (t4.loadCell(e5, this._workCell), 0 !== this._workCell.getWidth()) {
            if (this._workCell.fg !== h3 || this._workCell.bg !== c2) {
              ...
              r3 = e5, a2 = n3, h3 = this._workCell.fg, c2 = this._workCell.bg;
            }
      ...
      let u2 = t3.RenderService = class extends l2.Disposable {
        ...
        constructor(e3, t4, i3, s3, r3, h3, _3, u3) {
          ...
          })), this.register(i3.onMultipleOptionChange(["cursorBlink", "cursorStyle"], () => this.refreshRows(h3.buffer.y, h3.buffer.y, true))), this.register((0, n2.addDisposableDomListener)(_3.window, "resize", () => this.handleDevicePixelRatioChange())), this.register(u3.onChangeColors(() => this._fullRefresh())), "IntersectionObserver" in _3.window) {
      ...
      t3.RenderService = u2 = s2([r2(2, _2.IOptionsService), r2(3, h2.ICharSizeService), r2(4, _2.IDecorationService), r2(5, _2.IBufferService), r2(6, h2.ICoreBrowserService), r2(7, h2.IThemeService)], u2);
      ...
      const n2 = i2(9806), o = i2(9504), a = i2(456), h2 = i2(4725), c = i2(8460), l2 = i2(844), d = i2(6114), _2 = i2(4841), u2 = i2(511), f2 = i2(2585), v2 = String.fromCharCode(160), p2 = new RegExp(v2, "g");
      let g = t3.SelectionService = class extends l2.Disposable {
        constructor(e3, t4, i3, s3, r3, n3, o2, h3, d2) {
        ...
        _selectWordAtCursor(e3, t4) {
          var i3, s3;
          const r3 = null === (s3 = null === (i3 = this._linkifier.currentLink) || void 0 === i3 ? void 0 : i3.link) || void 0 === s3 ? void 0 : s3.range;
          ...
          return !!n3 && (this._selectWordAt(n3, t4), this._model.selectionEnd = void 0, true);
        }
        selectAll() {
        ...
        _getWordAt(e3, t4, i3 = true, s3 = true) {
          ...
          let a2 = this._convertViewportColToCharacterIndex(n3, e3[0]), h3 = a2;
          const c2 = e3[0] - a2;
          let l3 = 0, d2 = 0, _3 = 0, u3 = 0;
          if (" " === o2.charAt(a2)) {
            ...
            for (s4 > 1 && (u3 += s4 - 1, h3 += s4 - 1); t5 > 0 && a2 > 0 && !this._isCharWordSeparator(n3.loadCell(t5 - 1, this._workCell)); ) {
              ...
              0 === this._workCell.getWidth() ? (l3++, t5--) : e4 > 1 && (_3 += e4 - 1, a2 -= e4 - 1), a2--, t5--;
            }
            for (; i4 < n3.length && h3 + 1 < o2.length && !this._isCharWordSeparator(n3.loadCell(i4 + 1, this._workCell)); ) {
              n3.loadCell(i4 + 1, this._workCell);
              const e4 = this._workCell.getChars().length;
              2 === this._workCell.getWidth() ? (d2++, i4++) : e4 > 1 && (u3 += e4 - 1, h3 += e4 - 1), h3++, i4++;
            }
          }
          h3++;
          let f3 = a2 + c2 - l3 + _3, v3 = Math.min(this._bufferService.cols, h3 - a2 + l3 + d2 - _3 - u3);
      ...
      t3.SelectionService = g = s2([r2(3, f2.IBufferService), r2(4, f2.ICoreService), r2(5, h2.IMouseService), r2(6, f2.IOptionsService), r2(7, h2.IRenderService), r2(8, h2.ICoreBrowserService)], g);
    }, 4725: (e2, t3, i2) => {
      ...
      const n2 = i2(7239), o = i2(8055), a = i2(8460), h2 = i2(844), c = i2(2585), l2 = o.css.toColor("#ffffff"), d = o.css.toColor("#000000"), _2 = o.css.toColor("#ffffff"), u2 = o.css.toColor("#000000"), f2 = { css: "rgba(255, 255, 255, 0.3)", rgba: 4294967117 };
      ...
      t3.NULL_COLOR = { css: "#00000000", rgba: 0 }, function(e3) {
        e3.toCss = function(e4, t4, i3, s3) {
          return void 0 !== s3 ? `#${u2(e4)}${u2(t4)}${u2(i3)}${u2(s3)}` : `#${u2(e4)}${u2(t4)}${u2(i3)}`;
        }, e3.toRgba = function(e4, t4, i3, s3 = 255) {
          return (e4 << 24 | t4 << 16 | i3 << 8 | s3) >>> 0;
        };
      }(h2 || (t3.channels = h2 = {})), function(e3) {
        function t4(e4, t5) {
          return a = Math.round(255 * t5), [r2, n2, o] = _2.toChannels(e4.rgba), { css: h2.toCss(r2, n2, o, a), rgba: h2.toRgba(r2, n2, o, a) };
        }
        e3.blend = function(e4, t5) {
          if (a = (255 & t5.rgba) / 255, 1 === a) return { css: t5.css, rgba: t5.rgba };
          const i3 = t5.rgba >> 24 & 255, s3 = t5.rgba >> 16 & 255, c2 = t5.rgba >> 8 & 255, l3 = e4.rgba >> 24 & 255, d2 = e4.rgba >> 16 & 255, _3 = e4.rgba >> 8 & 255;
          return r2 = l3 + Math.round((i3 - l3) * a), n2 = d2 + Math.round((s3 - d2) * a), o = _3 + Math.round((c2 - _3) * a), { css: h2.toCss(r2, n2, o), rgba: h2.toRgba(r2, n2, o) };
        }, e3.isOpaque = function(e4) {
          return 255 == (255 & e4.rgba);
        }, e3.ensureContrastRatio = function(e4, t5, i3) {
          const s3 = _2.ensureContrastRatio(e4.rgba, t5.rgba, i3);
          if (s3) return _2.toColor(s3 >> 24 & 255, s3 >> 16 & 255, s3 >> 8 & 255);
        }, e3.opaque = function(e4) {
          const t5 = (255 | e4.rgba) >>> 0;
          return [r2, n2, o] = _2.toChannels(t5), { css: h2.toCss(r2, n2, o), rgba: t5 };
        ...
        e3.toColor = function(e4) {
          if (e4.match(/#[\da-f]{3,8}/i)) switch (e4.length) {
            case 4:
              return r2 = parseInt(e4.slice(1, 2).repeat(2), 16), n2 = parseInt(e4.slice(2, 3).repeat(2), 16), o = parseInt(e4.slice(3, 4).repeat(2), 16), _2.toColor(r2, n2, o);
            case 5:
              return r2 = parseInt(e4.slice(1, 2).repeat(2), 16), n2 = parseInt(e4.slice(2, 3).repeat(2), 16), o = parseInt(e4.slice(3, 4).repeat(2), 16), a = parseInt(e4.slice(4, 5).repeat(2), 16), _2.toColor(r2, n2, o, a);
            case 7:
          ...
          if (s3) return r2 = parseInt(s3[1]), n2 = parseInt(s3[2]), o = parseInt(s3[3]), a = Math.round(255 * (void 0 === s3[5] ? 1 : parseFloat(s3[5]))), _2.toColor(r2, n2, o, a);
          if (!t4 || !i3) throw new Error("css.toColor: Unsupported css format");
          if (t4.fillStyle = i3, t4.fillStyle = e4, "string" != typeof t4.fillStyle) throw new Error("css.toColor: Unsupported css format");
          if (t4.fillRect(0, 0, 1, 1), [r2, n2, o, a] = t4.getImageData(0, 0, 1, 1).data, 255 !== a) throw new Error("css.toColor: Unsupported css format");
          return { rgba: h2.toRgba(r2, n2, o, a), css: e4 };
        };
      }(l2 || (t3.css = l2 = {})), function(e3) {
        ...
        function t4(e4, t5, i4) {
          ...
          let o2 = t5 >> 24 & 255, a2 = t5 >> 16 & 255, h3 = t5 >> 8 & 255, c2 = f2(d.relativeLuminance2(o2, a2, h3), d.relativeLuminance2(s3, r3, n3));
          for (; c2 < i4 && (o2 > 0 || a2 > 0 || h3 > 0); ) o2 -= Math.max(0, Math.ceil(0.1 * o2)), a2 -= Math.max(0, Math.ceil(0.1 * a2)), h3 -= Math.max(0, Math.ceil(0.1 * h3)), c2 = f2(d.relativeLuminance2(o2, a2, h3), d.relativeLuminance2(s3, r3, n3));
          return (o2 << 24 | a2 << 16 | h3 << 8 | 255) >>> 0;
        }
        function i3(e4, t5, i4) {
          const s3 = e4 >> 24 & 255, r3 = e4 >> 16 & 255, n3 = e4 >> 8 & 255;
          let o2 = t5 >> 24 & 255, a2 = t5 >> 16 & 255, h3 = t5 >> 8 & 255, c2 = f2(d.relativeLuminance2(o2, a2, h3), d.relativeLuminance2(s3, r3, n3));
          for (; c2 < i4 && (o2 < 255 || a2 < 255 || h3 < 255); ) o2 = Math.min(255, o2 + Math.ceil(0.1 * (255 - o2))), a2 = Math.min(255, a2 + Math.ceil(0.1 * (255 - a2))), h3 = Math.min(255, h3 + Math.ceil(0.1 * (255 - h3))), c2 = f2(d.relativeLuminance2(o2, a2, h3), d.relativeLuminance2(s3, r3, n3));
          return (o2 << 24 | a2 << 16 | h3 << 8 | 255) >>> 0;
        }
        e3.ensureContrastRatio = function(e4, s3, r3) {
          const n3 = d.relativeLuminance(e4 >> 8), o2 = d.relativeLuminance(s3 >> 8);
          if (f2(n3, o2) < r3) {
            if (o2 < n3) {
              const o3 = t4(e4, s3, r3), a3 = f2(n3, d.relativeLuminance(o3 >> 8));
              if (a3 < r3) {
                const t5 = i3(e4, s3, r3);
                return a3 > f2(n3, d.relativeLuminance(t5 >> 8)) ? o3 : t5;
              }
              return o3;
            }
            const a2 = i3(e4, s3, r3), h3 = f2(n3, d.relativeLuminance(a2 >> 8));
            if (h3 < r3) {
              const i4 = t4(e4, s3, r3);
              return h3 > f2(n3, d.relativeLuminance(i4 >> 8)) ? a2 : i4;
            }
            return a2;
          }
          ...
          return { css: h2.toCss(e4, t5, i4, s3), rgba: h2.toRgba(e4, t5, i4, s3) };
        };
      }(_2 || (t3.rgba = _2 = {})), t3.toPaddedHex = u2, t3.contrastRatio = f2;
    }, 8969: (e2, t3, i2) => {
      Object.defineProperty(t3, "__esModule", { value: true }), t3.CoreTerminal = void 0;
      const s2 = i2(844), r2 = i2(2585), n2 = i2(4348), o = i2(7866), a = i2(744), h2 = i2(7302), c = i2(6975), l2 = i2(8460), d = i2(1753), _2 = i2(1480), u2 = i2(7994), f2 = i2(9282), v2 = i2(5435), p2 = i2(5981), g = i2(2660);
      let m2 = false;
      ...
      const n2 = i2(2584), o = i2(7116), a = i2(2015), h2 = i2(844), c = i2(482), l2 = i2(8437), d = i2(8460), _2 = i2(643), u2 = i2(511), f2 = i2(3734), v2 = i2(2585), p2 = i2(6242), g = i2(6351), m2 = i2(5941), S2 = { "(": 0, ")": 1, "*": 2, "+": 3, "-": 1, ".": 2 }, C2 = 131072;
      function b(e3, t4) {
      ...
      class E2 extends h2.Disposable {
        ...
        parse(e3, t4) {
          ...
          if (o2) {
            ...
            s3 = this._parseStack.cursorStartX, r3 = this._parseStack.cursorStartY, this._parseStack.paused = false, e3.length > C2 && (n3 = this._parseStack.position + C2);
          }
          if (this._logService.logLevel <= v2.LogLevelEnum.DEBUG && this._logService.debug("parsing data" + ("string" == typeof e3 ? ` "${e3}"` : ` "${Array.prototype.map.call(e3, (e4) => String.fromCharCode(e4)).join("")}"`), "string" == typeof e3 ? e3.split("").map((e4) => e4.charCodeAt(0)) : e3), this._parseBuffer.length < e3.length && this._parseBuffer.length < C2 && (this._parseBuffer = new Uint32Array(Math.min(e3.length, C2))), o2 || this._dirtyRowTracker.clearRange(), e3.length > C2) for (let t5 = n3; t5 < e3.length; t5 += C2) {
            const n4 = t5 + C2 < e3.length ? t5 + C2 : e3.length, o3 = "string" == typeof e3 ? this._stringDecoder.decode(e3.substring(t5, n4), this._parseBuffer) : this._utf8Decoder.decode(e3.subarray(t5, n4), this._parseBuffer);
          ...
          this._activeBuffer.x === s3 && this._activeBuffer.y === r3 || this._onCursorMove.fire(), this._onRequestRefreshRows.fire(this._dirtyRowTracker.start, this._dirtyRowTracker.end);
        }
        print(e3, t4, i3) {
          let s3, r3;
          const n3 = this._charsetService.charset, o2 = this._optionsService.rawOptions.screenReaderMode, a2 = this._bufferService.cols, h3 = this._coreService.decPrivateModes.wraparound, l3 = this._coreService.modes.insertMode, d2 = this._curAttrData;
          let u3 = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
          this._dirtyRowTracker.markDirty(this._activeBuffer.y), this._activeBuffer.x && i3 - t4 > 0 && 2 === u3.getWidth(this._activeBuffer.x - 1) && u3.setCellFromCodePoint(this._activeBuffer.x - 1, 0, 1, d2.fg, d2.bg, d2.extended);
          for (let f3 = t4; f3 < i3; ++f3) {
            if (s3 = e3[f3], r3 = this._unicodeService.wcwidth(s3), s3 < 127 && n3) {
              const e4 = n3[String.fromCharCode(s3)];
              e4 && (s3 = e4.charCodeAt(0));
            }
            if (o2 && this._onA11yChar.fire((0, c.stringFromCodePoint)(s3)), this._getCurrentLinkId() && this._oscLinkService.addLineToLink(this._getCurrentLinkId(), this._activeBuffer.ybase + this._activeBuffer.y), r3 || !this._activeBuffer.x) {
              if (this._activeBuffer.x + r3 - 1 >= a2) {
                if (h3) {
                  for (; this._activeBuffer.x < a2; ) u3.setCellFromCodePoint(this._activeBuffer.x++, 0, 1, d2.fg, d2.bg, d2.extended);
              ...
              if (l3 && (u3.insertCells(this._activeBuffer.x, r3, this._activeBuffer.getNullCell(d2), d2), 2 === u3.getWidth(a2 - 1) && u3.setCellFromCodePoint(a2 - 1, _2.NULL_CELL_CODE, _2.NULL_CELL_WIDTH, d2.fg, d2.bg, d2.extended)), u3.setCellFromCodePoint(this._activeBuffer.x++, s3, r3, d2.fg, d2.bg, d2.extended), r3 > 0) for (; --r3; ) u3.setCellFromCodePoint(this._activeBuffer.x++, 0, 0, d2.fg, d2.bg, d2.extended);
            } else u3.getWidth(this._activeBuffer.x - 1) ? u3.addCodepointToCell(this._activeBuffer.x - 1, s3) : u3.addCodepointToCell(this._activeBuffer.x - 2, s3);
          }
          i3 - t4 > 0 && (u3.loadCell(this._activeBuffer.x - 1, this._workCell), 2 === this._workCell.getWidth() || this._workCell.getCode() > 65535 ? this._parser.precedingCodepoint = 0 : this._workCell.isCombined() ? this._parser.precedingCodepoint = this._workCell.getChars().charCodeAt(0) : this._parser.precedingCodepoint = this._workCell.content), this._activeBuffer.x < a2 && i3 - t4 > 0 && 0 === u3.getWidth(this._activeBuffer.x) && !u3.hasContent(this._activeBuffer.x) && u3.setCellFromCodePoint(this._activeBuffer.x, 0, 1, d2.fg, d2.bg, d2.extended), this._dirtyRowTracker.markDirty(this._activeBuffer.y);
        }
        registerCsiHandler(e3, t4) {
        ...
        registerOscHandler(e3, t4) {
          return this._parser.registerOscHandler(e3, new p2.OscHandler(t4));
        }
        bell() {
        ...
        _eraseInBufferLine(e3, t4, i3, s3 = false, r3 = false) {
          ...
          n3.replaceCells(t4, i3, this._activeBuffer.getNullCell(this._eraseAttrData()), this._eraseAttrData(), r3), s3 && (n3.isWrapped = false);
        }
        ...
        repeatPrecedingCharacter(e3) {
          ...
          for (let e4 = 0; e4 < t4; ++e4) i3[e4] = this._parser.precedingCodepoint;
        ...
        requestMode(e3, t4) {
          const i3 = this._coreService.decPrivateModes, { activeProtocol: s3, activeEncoding: r3 } = this._coreMouseService, o2 = this._coreService, { buffers: a2, cols: h3 } = this._bufferService, { active: c2, alt: l3 } = a2, d2 = this._optionsService.rawOptions, _3 = (e4) => e4 ? 1 : 2, u3 = e3.params[0];
          return f3 = u3, v3 = t4 ? 2 === u3 ? 4 : 4 === u3 ? _3(o2.modes.insertMode) : 12 === u3 ? 3 : 20 === u3 ? _3(d2.convertEol) : 0 : 1 === u3 ? _3(i3.applicationCursorKeys) : 3 === u3 ? d2.windowOptions.setWinLines ? 80 === h3 ? 2 : 132 === h3 ? 1 : 0 : 0 : 6 === u3 ? _3(i3.origin) : 7 === u3 ? _3(i3.wraparound) : 8 === u3 ? 3 : 9 === u3 ? _3("X10" === s3) : 12 === u3 ? _3(d2.cursorBlink) : 25 === u3 ? _3(!o2.isCursorHidden) : 45 === u3 ? _3(i3.reverseWraparound) : 66 === u3 ? _3(i3.applicationKeypad) : 67 === u3 ? 4 : 1e3 === u3 ? _3("VT200" === s3) : 1002 === u3 ? _3("DRAG" === s3) : 1003 === u3 ? _3("ANY" === s3) : 1004 === u3 ? _3(i3.sendFocus) : 1005 === u3 ? 4 : 1006 === u3 ? _3("SGR" === r3) : 1015 === u3 ? 4 : 1016 === u3 ? _3("SGR_PIXELS" === r3) : 1048 === u3 ? 1 : 47 === u3 || 1047 === u3 || 1049 === u3 ? _3(c2 === l3) : 2004 === u3 ? _3(i3.bracketedPasteMode) : 0, o2.triggerDataEvent(`${n2.C0.ESC}[${t4 ? "" : "?"}${f3};${v3}$y`), true;
          var f3, v3;
        }
        ...
        setOrReportIndexedColor(e3) {
          ...
          for (; i3.length > 1; ) {
            ...
            if (/^\d+$/.exec(e4)) {
              ...
              if (L2(i4)) if ("?" === s3) t4.push({ type: 0, index: i4 });
              else {
      ...
      let k2 = class {
        ...
        markRangeDirty(e3, t4) {
          e3 > t4 && (w2 = e3, e3 = t4, t4 = w2), e3 < this.start && (this.start = e3), t4 > this.end && (this.end = t4);
        }
        markAllDirty() {
      ...
      k2 = s2([r2(0, v2.IBufferService)], k2);
    }, 844: (e2, t3) => {
      function i2(e3) {
        for (const t4 of e3) t4.dispose();
        e3.length = 0;
      ...
      t3.TwoKeyMap = i2, t3.FourKeyMap = class {
        ...
        get(e3, t4, i3, s2) {
          var r2;
          return null === (r2 = this._data.get(e3, t4)) || void 0 === r2 ? void 0 : r2.get(i3, s2);
        }
        clear() {
          this._data.clear();
        }
      ...
      t3.updateWindowsModeWrappedState = function(e3) {
        const t4 = e3.buffer.lines.get(e3.buffer.ybase + e3.buffer.y - 1), i3 = null == t4 ? void 0 : t4.get(e3.cols - 1), r2 = e3.buffer.lines.get(e3.buffer.ybase + e3.buffer.y);
      ...
      const s2 = i2(6349), r2 = i2(7226), n2 = i2(3734), o = i2(8437), a = i2(4634), h2 = i2(511), c = i2(643), l2 = i2(4863), d = i2(7116);
      t3.MAX_BUFFER_SIZE = 4294967295, t3.Buffer = class {
        ...
        _reflowSmaller(e3, t4) {
          ...
          for (let n3 = this.lines.length - 1; n3 >= 0; n3--) {
            ...
            const c2 = [h3];
            for (; h3.isWrapped && n3 > 0; ) h3 = this.lines.get(--n3), c2.unshift(h3);
            const l3 = this.ybase + this.y;
            if (l3 >= n3 && l3 < n3 + c2.length) continue;
            const d2 = c2[c2.length - 1].getTrimmedLength(), _2 = (0, a.reflowSmallerGetNewLineLengths)(c2, this._cols, e3), u2 = _2.length - c2.length;
            let f2;
            ...
            for (; m2 >= 0; ) {
              ...
              if (c2[p2].copyCellsFrom(c2[m2], S2 - e4, g - e4, e4, true), g -= e4, 0 === g && (p2--, g = _2[p2]), S2 -= e4, 0 === S2) {
                m2--;
                const e5 = Math.max(m2, 0);
                S2 = (0, a.getWrappedLineTrimmedLength)(c2, e5, this._cols);
              }
            }
            for (let t5 = 0; t5 < c2.length; t5++) _2[t5] < e3 && c2[t5].setCell(_2[t5], i3);
            let C2 = u2 - f2;
          ...
          if (s3.length > 0) {
            ...
            let h3 = 0;
            for (let c3 = Math.min(this.lines.maxLength - 1, i4 + r3 - 1); c3 >= 0; c3--) if (a2 && a2.start > n3 + h3) {
              for (let e5 = a2.newLines.length - 1; e5 >= 0; e5--) this.lines.set(c3--, a2.newLines[e5]);
              c3++, e4.push({ index: n3 + 1, amount: a2.newLines.length }), h3 += a2.newLines.length, a2 = s3[++o2];
      ...
      class h2 {
        ...
        setCellFromCodePoint(e3, t4, i3, s3, r3, n3) {
          268435456 & r3 && (this._extendedAttrs[e3] = n3), this._data[3 * e3 + 0] = t4 | i3 << 22, this._data[3 * e3 + 1] = s3, this._data[3 * e3 + 2] = r3;
        }
        ...
        insertCells(e3, t4, i3, n3) {
          if ((e3 %= this.length) && 2 === this.getWidth(e3 - 1) && this.setCellFromCodePoint(e3 - 1, 0, 1, (null == n3 ? void 0 : n3.fg) || 0, (null == n3 ? void 0 : n3.bg) || 0, (null == n3 ? void 0 : n3.extended) || new s2.ExtendedAttrs()), t4 < this.length - e3) {
          ...
          2 === this.getWidth(this.length - 1) && this.setCellFromCodePoint(this.length - 1, 0, 1, (null == n3 ? void 0 : n3.fg) || 0, (null == n3 ? void 0 : n3.bg) || 0, (null == n3 ? void 0 : n3.extended) || new s2.ExtendedAttrs());
        }
        deleteCells(e3, t4, i3, n3) {
          ...
          e3 && 2 === this.getWidth(e3 - 1) && this.setCellFromCodePoint(e3 - 1, 0, 1, (null == n3 ? void 0 : n3.fg) || 0, (null == n3 ? void 0 : n3.bg) || 0, (null == n3 ? void 0 : n3.extended) || new s2.ExtendedAttrs()), 0 !== this.getWidth(e3) || this.hasContent(e3) || this.setCellFromCodePoint(e3, 0, 1, (null == n3 ? void 0 : n3.fg) || 0, (null == n3 ? void 0 : n3.bg) || 0, (null == n3 ? void 0 : n3.extended) || new s2.ExtendedAttrs());
        }
        replaceCells(e3, t4, i3, r3, n3 = false) {
          if (n3) for (e3 && 2 === this.getWidth(e3 - 1) && !this.isProtected(e3 - 1) && this.setCellFromCodePoint(e3 - 1, 0, 1, (null == r3 ? void 0 : r3.fg) || 0, (null == r3 ? void 0 : r3.bg) || 0, (null == r3 ? void 0 : r3.extended) || new s2.ExtendedAttrs()), t4 < this.length && 2 === this.getWidth(t4 - 1) && !this.isProtected(t4) && this.setCellFromCodePoint(t4, 0, 1, (null == r3 ? void 0 : r3.fg) || 0, (null == r3 ? void 0 : r3.bg) || 0, (null == r3 ? void 0 : r3.extended) || new s2.ExtendedAttrs()); e3 < t4 && e3 < this.length; ) this.isProtected(e3) || this.setCell(e3, i3), e3++;
          else for (e3 && 2 === this.getWidth(e3 - 1) && this.setCellFromCodePoint(e3 - 1, 0, 1, (null == r3 ? void 0 : r3.fg) || 0, (null == r3 ? void 0 : r3.bg) || 0, (null == r3 ? void 0 : r3.extended) || new s2.ExtendedAttrs()), t4 < this.length && 2 === this.getWidth(t4 - 1) && this.setCellFromCodePoint(t4, 0, 1, (null == r3 ? void 0 : r3.fg) || 0, (null == r3 ? void 0 : r3.bg) || 0, (null == r3 ? void 0 : r3.extended) || new s2.ExtendedAttrs()); e3 < t4 && e3 < this.length; ) this.setCell(e3++, i3);
        }
        resize(e3, t4) {
        ...
        translateToString(e3 = false, t4 = 0, i3 = this.length) {
          ...
          for (; t4 < i3; ) {
            ...
            s3 += 2097152 & e4 ? this._combined[t4] : i4 ? (0, o.stringFromCodePoint)(i4) : n2.WHITESPACE_CELL_CHAR, t4 += e4 >> 22 || 1;
          }
          return s3;
        }
      }
      ...
      Object.defineProperty(t3, "__esModule", { value: true }), t3.getWrappedLineTrimmedLength = t3.reflowSmallerGetNewLineLengths = t3.reflowLargerApplyNewLayout = t3.reflowLargerCreateNewLayout = t3.reflowLargerGetLinesToRemove = void 0, t3.reflowLargerGetLinesToRemove = function(e3, t4, s2, r2, n2) {
        ...
        for (let a = 0; a < e3.length - 1; a++) {
          ...
          let d = 0, _2 = i2(l2, d, t4), u2 = 1, f2 = 0;
          for (; u2 < l2.length; ) {
            const e4 = i2(l2, u2, t4), r3 = e4 - f2, o2 = s2 - _2, a2 = Math.min(r3, o2);
            l2[d].copyCellsFrom(l2[u2], f2, _2, a2, false), _2 += a2, _2 === s2 && (d++, _2 = 0), f2 += a2, f2 === e4 && (u2++, f2 = 0), 0 === _2 && 0 !== d && 2 === l2[d - 1].getWidth(s2 - 1) && (l2[d].copyCellsFrom(l2[d - 1], s2 - 1, _2++, 1, false), l2[d - 1].setCell(s2 - 1, n2));
          }
          l2[d].replaceCells(_2, s2, n2);
          let v2 = 0;
        ...
        switch (e3.keyCode) {
          ...
          default:
            if (!e3.ctrlKey || e3.shiftKey || e3.altKey || e3.metaKey) if (i3 && !n2 || !e3.altKey || e3.metaKey) !i3 || e3.altKey || e3.ctrlKey || e3.shiftKey || !e3.metaKey ? e3.key && !e3.ctrlKey && !e3.altKey && !e3.metaKey && e3.keyCode >= 48 && 1 === e3.key.length ? o.key = e3.key : e3.key && e3.ctrlKey && ("_" === e3.key && (o.key = s2.C0.US), "@" === e3.key && (o.key = s2.C0.NUL)) : 65 === e3.keyCode && (o.type = 1);
              ...
              const t5 = r2[e3.keyCode], i4 = null == t5 ? void 0 : t5[e3.shiftKey ? 1 : 0];
      ...
      Object.defineProperty(t3, "__esModule", { value: true }), t3.Utf8ToUtf32 = t3.StringToUtf32 = t3.utf32ToString = t3.stringFromCodePoint = void 0, t3.stringFromCodePoint = function(e3) {
        ...
        decode(e3, t4) {
          ...
          if (this.interim[0]) {
            ...
            s3 || (2 === h3 ? r3 < 128 ? c-- : t4[a++] = r3 : 3 === h3 ? r3 < 2048 || r3 >= 55296 && r3 <= 57343 || 65279 === r3 || (t4[a++] = r3) : r3 < 65536 || r3 > 1114111 || (t4[a++] = r3)), this.interim.fill(0);
          }
          const l2 = i2 - 4;
          let d = c;
          for (; d < i2; ) {
            ...
            if (s2 = e3[d++], s2 < 128) t4[a++] = s2;
              ...
              if (h2 = (7 & s2) << 18 | (63 & r2) << 12 | (63 & n2) << 6 | 63 & o, h2 < 65536 || h2 > 1114111) continue;
              t4[a++] = h2;
            }
          }
          return a;
      ...
      t3.UnicodeV6 = class {
        constructor() {
          if (this.version = "6", !r2) {
            ...
            for (let e3 = 0; e3 < i2.length; ++e3) r2.fill(0, i2[e3][0], i2[e3][1] + 1);
          }
        }
        wcwidth(e3) {
          return e3 < 32 ? 0 : e3 < 127 ? 1 : e3 < 65536 ? r2[e3] : function(e4, t4) {
      ...
      class c extends s2.Disposable {
        constructor(e3 = t3.VT500_TRANSITION_TABLE) {
          super(), this._transitions = e3, this._parseStack = { state: 0, handlers: [], handlerPos: 0, transition: 0, chunkPos: 0 }, this.initialState = 0, this.currentState = this.initialState, this._params = new r2.Params(), this._params.addParam(0), this._collect = 0, this.precedingCodepoint = 0, this._printHandlerFb = (e4, t4, i3) => {
        ...
        parse(e3, t4, i3) {
          ...
          for (let i4 = o2; i4 < t4; ++i4) {
            switch (r3 = e3[i4], n3 = this._transitions.table[this.currentState << 8 | (r3 < 160 ? r3 : h2)], n3 >> 4) {
              case 2:
                for (let s4 = i4 + 1; ; ++s4) {
                  if (s4 >= t4 || (r3 = e3[s4]) < 32 || r3 > 126 && r3 < h2) {
              ...
              case 7:
                ...
                a2 < 0 && this._csiHandlerFb(this._collect << 8 | r3, this._params), this.precedingCodepoint = 0;
                break;
              case 8:
                do {
                  switch (r3) {
              ...
              case 12:
                ...
                break;
              case 13:
                for (let s4 = i4 + 1; ; ++s4) if (s4 >= t4 || 24 === (r3 = e3[s4]) || 26 === r3 || 27 === r3 || r3 > 127 && r3 < h2) {
              ...
              case 14:
                ...
                27 === r3 && (n3 |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0, this.precedingCodepoint = 0;
                break;
              case 4:
                this._oscParser.start();
                break;
              case 5:
                for (let s4 = i4 + 1; ; s4++) if (s4 >= t4 || (r3 = e3[s4]) < 32 || r3 > 127 && r3 < h2) {
      ...
      const n2 = i2(8460), o = i2(844), a = i2(5295), h2 = i2(2585);
      ...
      t3.BufferService = c = s2([r2(0, h2.IOptionsService)], c);
    }, 7994: (e2, t3) => {
      ...
      const n2 = i2(2585), o = i2(8460), a = i2(844), h2 = { NONE: { events: 0, restrict: () => false }, X10: { events: 1, restrict: (e3) => 4 !== e3.button && 1 === e3.action && (e3.ctrl = false, e3.alt = false, e3.shift = false, true) }, VT200: { events: 19, restrict: (e3) => 32 !== e3.action }, DRAG: { events: 23, restrict: (e3) => 32 !== e3.action || 3 !== e3.button }, ANY: { events: 31, restrict: (e3) => true } };
      function c(e3, t4) {
      ...
      t3.CoreMouseService = _2 = s2([r2(0, n2.IBufferService), r2(1, n2.ICoreService)], _2);
      ...
      const n2 = i2(1439), o = i2(8460), a = i2(844), h2 = i2(2585), c = Object.freeze({ insertMode: false }), l2 = Object.freeze({ applicationCursorKeys: false, applicationKeypad: false, bracketedPasteMode: false, origin: false, reverseWraparound: false, sendFocus: false, wraparound: true });
      ...
      t3.CoreService = d = s2([r2(0, h2.IBufferService), r2(1, h2.ILogService), r2(2, h2.IOptionsService)], d);
    }, 9074: (e2, t3, i2) => {
      ...
      class c extends n2.Disposable {
        ...
        *getDecorationsAtCell(e3, t4, i3) {
          var s3, r3, n3;
          let o2 = 0, a2 = 0;
          for (const h3 of this._decorations.getKeyIterator(t4)) o2 = null !== (s3 = h3.options.x) && void 0 !== s3 ? s3 : 0, a2 = o2 + (null !== (r3 = h3.options.width) && void 0 !== r3 ? r3 : 1), e3 >= o2 && e3 < a2 && (!i3 || (null !== (n3 = h3.options.layer) && void 0 !== n3 ? n3 : "bottom") === i3) && (yield h3);
        }
        forEachDecorationAtCell(e3, t4, i3, s3) {
          this._decorations.forEachByKey(t4, (t5) => {
            var r3, n3, o2;
            a = null !== (r3 = t5.options.x) && void 0 !== r3 ? r3 : 0, h2 = a + (null !== (n3 = t5.options.width) && void 0 !== n3 ? n3 : 1), e3 >= a && e3 < h2 && (!i3 || (null !== (o2 = t5.options.layer) && void 0 !== o2 ? o2 : "bottom") === i3) && s3(t5);
          });
        }
      }
      ...
      let h2, c = t3.LogService = class extends n2.Disposable {
        get logLevel() {
      ...
      t3.UnicodeService = class {
        ...
        getStringCellWidth(e3) {
          ...
          for (let s3 = 0; s3 < i3; ++s3) {
            let r3 = e3.charCodeAt(s3);
            if (55296 <= r3 && r3 <= 56319) {
              if (++s3 >= i3) return t4 + this.wcwidth(r3);
              const n2 = e3.charCodeAt(s3);
              56320 <= n2 && n2 <= 57343 ? r3 = 1024 * (r3 - 55296) + n2 - 56320 + 65536 : t4 += this.wcwidth(n2);
            }
            t4 += this.wcwidth(r3);
          }
          return t4;
    ...
    return (() => {
      ...
      const t3 = i(9042), r2 = i(3236), n2 = i(844), o = i(5741), a = i(8285), h2 = i(7975), c = i(7090), l2 = ["cols", "rows"];
      class d extends n2.Disposable {
        constructor(e3) {
          super(), this._core = this.register(new r2.Terminal(e3)), this._addonManager = this.register(new o.AddonManager()), this._publicOptions = Object.assign({}, this._core.options);
...
function TerminalPanel({ workspaceRoot }) {
      ...
      children: openFiles.map((file) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: fileNameForPath(file.path) }),
              file.dirty && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--accent)" }, children: "●" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  onClick: (e) => {
...
function StatusBar({ workspaceRoot, model, ollamaOnline }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: workspaceRoot ?? "Nenhuma pasta aberta" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: ollamaOnline === false ? "Ollama offline" : `Modelo: ${model || "—"}` })
      ]
    }
  );
}
function AgentPanel({
  ...
  const [ollamaOnline, setOllamaOnline] = reactExports.useState(null);
  const [messages, setMessages] = reactExports.useState([]);
  const [prompt, setPrompt] = reactExports.useState("");
  const [running, setRunning] = reactExports.useState(false);
  const [autoApprove, setAutoApprove] = reactExports.useState(false);
  const [pendingApproval, setPendingApproval] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    const off = window.kiln.agent.onEvent(async (event) => {
      switch (event.type) {
        case "assistant_text":
          setMessages((old) => [
            ...old,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100%", minHeight: 0 }, children: [
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              style: { flex: 1 },
              children: [
                models.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Nenhum modelo" }),
                models.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: m2.name, children: m2.name }, m2.name))
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: refreshModels, title: "Atualizar modelos", children: "↻" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: scrollRef, style: { flex: 1, overflowY: "auto", padding: "8px 10px", minHeight: 0 }, children: [
      messages.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
            marginBottom: 10,
            ...
            lineHeight: 1.5,
            whiteSpace: "pre-wrap",
            background: m2.role === "user" ? "var(--accent)" : "var(--bg-elevated)",
            color: m2.role === "user" ? "#fff" : "var(--text)",
            marginLeft: m2.role === "user" ? 24 : 0,
            marginRight: m2.role === "user" ? 0 : 24
          },
          children: m2.content
        },
        m2.id
      )),
      running && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "var(--text-dim)", padding: "4px 10px" }, children: "⏳ Agente trabalhando..." }),
      pendingApproval && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          style: {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "6px 10px", fontSize: 12, background: "var(--bg-elevated)" }, children: [
              "Aprovar alteração em ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: pendingApproval.preview?.path ?? "—" }),
              "?"
            ] }),
            pendingApproval.preview && /* @__PURE__ */ jsxRuntimeExports.jsx(
              we,
              {
                height: "220px",
                theme: "vs-dark",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, padding: 8, justifyContent: "flex-end" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: reject, children: "Rejeitar" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "primary", onClick: approve, children: "Aprovar" })
            ] })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { borderTop: "1px solid var(--border)", padding: 8, flexShrink: 0 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          value: prompt,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          style: { width: "100%" },
          children: running ? "Executando..." : "Enviar"
        }
      )
    ] })
  ] });
...
function App() {
  const [workspaceRoot, setWorkspaceRoot] = reactExports.useState(null);
  const [activityView, setActivityView] = reactExports.useState("explorer");
  const [openFiles, setOpenFiles] = reactExports.useState([]);
  const [activePath, setActivePath] = reactExports.useState(null);
  const [fileContents, setFileContents] = reactExports.useState({});
  const [explorerRefreshToken, setExplorerRefreshToken] = reactExports.useState(0);
  const [gitRefreshToken, setGitRefreshToken] = reactExports.useState(0);
  const [ollamaOnline] = reactExports.useState(null);
  const [currentModel] = reactExports.useState("");
  ...
  async function openFile(path) {
    ...
    setOpenFiles(
      (files) => files.some((f2) => f2.path === path) ? files : [...files, { path, dirty: false }]
    );
    setActivePath(path);
  }
  function closeFile(path) {
    setOpenFiles((files) => files.filter((f2) => f2.path !== path));
    if (activePath === path) {
      setOpenFiles((files) => {
        const remaining = files.filter((f2) => f2.path !== path);
  ...
  async function saveActiveFile() {
    ...
    setOpenFiles(
      (files) => files.map((f2) => f2.path === activePath ? { ...f2, dirty: false } : f2)
    );
    setGitRefreshToken((t2) => t2 + 1);
  }
  const onExternalFileChange = reactExports.useCallback(
    async (path) => {
      ...
      setExplorerRefreshToken((t2) => t2 + 1);
      setGitRefreshToken((t2) => t2 + 1);
    },
    [workspaceRoot]
  );
  if (!workspaceRoot) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontWeight: 500 }, children: "Kiln" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "primary", onClick: openFolder, children: "Abrir pasta" })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-body", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ActivityBar, { active: activityView, onChange: setActivityView }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar", children: [
        activityView === "explorer" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          FileExplorer,
          {
            workspaceRoot,
            activePath,
        ...
        activityView === "source-control" && /* @__PURE__ */ jsxRuntimeExports.jsx(SourceControlPanel, { workspaceRoot, refreshToken: gitRefreshToken }),
        activityView === "terminal" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "panel-title", children: "Use o painel inferior" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "main-column", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          EditorTabs,
          {
            openFiles,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, minHeight: 0 }, children: activePath ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ft,
          {
            height: "100%",
            theme: "vs-dark",
            ...
            onChange: (value) => {
              ...
              setOpenFiles(
                (files) => files.map((f2) => f2.path === activePath ? { ...f2, dirty: true } : f2)
              );
            },
            onMount: (editor) => {
              editor.addCommand(
        ...
        activityView === "terminal" && /* @__PURE__ */ jsxRuntimeExports.jsx(TerminalPanel, { workspaceRoot })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "agent-column", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AgentPanel, { workspaceRoot, onExternalFileChange }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StatusBar, { workspaceRoot, model: currentModel, ollamaOnline })
  ] });
}
